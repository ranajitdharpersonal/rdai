...
def main_callback(
    ...
    """Show the RDAI dashboard when no command is supplied."""
...
app.command(
    name="init",
    help="Setup your AI providers & strategy",
)(setup_init)
...
app.command(
    name="doctor",
    help="Check your API keys",
)(run_doctor)

app.command(
    name="about",
    help="Learn about the rdai orchestrator",
)(run_about)

app.command(
    name="config",
    help="View your current routing config",
)(run_config)

app.command(
    name="benchmark",
    help="Run a latency test on models",
)(run_benchmark)
